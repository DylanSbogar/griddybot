...
const FORTNITE_API_URL: string = "https://fortnite-api.com/v2/cosmetics/br/search?name=";
const GRIDDY_ICON_URL: string = "https://cdn-0.skin-tracker.com/images/fnskins/icon/fortnite-get-griddy-emote.png?ezimgfmt=rs:180x180/rscb10/ngcb10/notWebP";
...
module.exports = {
  ...
  async execute(interaction: ChatInputCommandInteraction): Promise<void> {
    try {
      ...
      const dataJSON: FortniteApiResponse = (await (await fetch(request)).json()) as FortniteApiResponse;
      const lastAppearanceUTC: string | undefined = dataJSON.data.shopHistory.pop();
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          {
            name: "Status",
            value: lastAppearanceLocal.getTime() === today.getTime() ? "✅" : "❌",
            inline: true,
          }
        )
        .addFields({
